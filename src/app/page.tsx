...
export default function Home() {
  return (
    <div className="">
      <Navbar />
      <section className="container mx-auto px-8 text-center flex items-center justify-center h-5/6 max-w-[88rem]">
        <div>
          <h1 className=" mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-4xl dark:text-white">
            Hello! Welcome To BaiBucks Community Forum.
          </h1>
...
const Icons = {
  gitHub: () => (
    <Image
      src="/baibucks/public/images/vectors/vector1.png"
      width={100}
      height={100}
      alt="github"
    />
